...
class JobHistoryResourceIT {
    ...
    public static JobHistory createEntity(EntityManager em) {
        JobHistory jobHistory = new JobHistory().employeeId(DEFAULT_EMPLOYEE_ID).startDate(DEFAULT_START_DATE).endDate(DEFAULT_END_DATE);
        return jobHistory;
    }
    ...
    public static JobHistory createUpdatedEntity(EntityManager em) {
        JobHistory jobHistory = new JobHistory().employeeId(UPDATED_EMPLOYEE_ID).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
        return jobHistory;
    }
    ...
    void putNewJobHistory() throws Exception {
        ...
        updatedJobHistory.employeeId(UPDATED_EMPLOYEE_ID).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
    ...
    void fullUpdateJobHistoryWithPatch() throws Exception {
        ...
        partialUpdatedJobHistory.employeeId(UPDATED_EMPLOYEE_ID).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
